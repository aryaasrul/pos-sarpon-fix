-- Migration 002: Update create_transaction — tambah pengurangan stok
-- Menggabungkan insert transaksi + kurangi stok buku + kurangi stok ingredient
-- dalam satu atomic operation.
--
-- Cara apply: jalankan di Supabase Dashboard → SQL Editor → New query → Run
-- (Boleh dijalankan ulang — pakai CREATE OR REPLACE)
