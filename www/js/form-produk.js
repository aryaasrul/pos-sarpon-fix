...
async function saveMenuItem() {
  ...
  if (!name) { showToast('Nama menu tidak boleh kosong'); return; }
...
async function saveBook() {
  ...
  if (!title)       { showToast('Judul buku tidak boleh kosong'); return; }
  if (selling <= 0) { showToast('Harga jual harus diisi'); return; }
